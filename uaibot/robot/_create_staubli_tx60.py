...
def _create_staubli_tx60(htm, name, color, opacity):
    ...
    base_3d_obj = [Model3D(
        'https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/StaubliTX60/base_link.stl',
        scale,
        np.identity(4),
    ...
    link_3d_obj.append(
        [Model3D(
            'https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/StaubliTX60/link_1.stl',
            scale,
    ...
    link_3d_obj.append(
        [Model3D(
            'https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/StaubliTX60/link_2.stl',
            scale,
    ...
    link_3d_obj.append(
        [Model3D(
            'https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/StaubliTX60/link_3.stl',
            scale,
    ...
    link_3d_obj.append(
        [Model3D(
            'https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/StaubliTX60/link_4.stl',
            scale,
    ...
    link_3d_obj.append(
        [Model3D(
            'https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/StaubliTX60/link_5.stl',
            scale,
            np.identity(4),
    ...
    link_3d_obj.append(
        [Model3D(
            'https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/StaubliTX60/link_6.stl',
            scale,
            np.identity(4),
