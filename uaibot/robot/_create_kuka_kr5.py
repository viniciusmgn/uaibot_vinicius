...
def _create_kuka_kr5(htm, name, color, opacity):
    ...
    base_3d_obj = [
        Model3D('https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/KukaKR5/Base.obj',
                0.001,
    ...
    link_3d_obj.append(
        [Model3D('https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/KukaKR5/Axis1.obj',
                 0.001,
    ...
    link_3d_obj.append(
        [Model3D('https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/KukaKR5/Axis2.obj',
                 0.001,
    ...
    link_3d_obj.append(
        [Model3D('https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/KukaKR5/Axis3.obj',
                 0.001,
    ...
    link_3d_obj.append(
        [Model3D('https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/KukaKR5/Axis4.obj',
                 0.001,
    ...
    link_3d_obj.append(
        [Model3D('https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/KukaKR5/Axis5.obj',
                 0.001,
    ...
    link_3d_obj.append(
        [Model3D('https://raw.githubusercontent.com/viniciusmgn/jupyterbot_vinicius/test/contents/KukaKR5/Axis6.obj',
                 0.001,
